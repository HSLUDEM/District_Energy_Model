...
@author: UeliSchilt, pascalvecsei

Base class for solar PV technologies
"""
...
class SolarPVBase(TechCore):
    ...
    def update_tech_properties(self, tech_dict):
        ...
        """
        # Properties:
        self.v_max_kwp = tech_dict['kWp_max']
        
        self._eta_panel = tech_dict['eta_panel']
        self._eta_inverter = tech_dict['eta_inverter']
                
        self._lifetime = tech_dict['lifetime']
        
        self._interest_rate = tech_dict['interest_rate']
        
        self._base_capex = tech_dict['base_capex'] #base_capex in Fr./kWp installed power (not be confused with the real peak power)
        ...
        self._capex = ...
        self._profiles = ...
        self._capex_opex_increase_factors = ...
