...
scen_techs = {
    ...
    'heat_pump':{ #hp 
        'deployment':True,
        # 'deployment':False,
        'kW_th_max':'inf', #Source: Philippen et al. (2025). CoSi modelling assumptions. SWEET-CoSi
        'lifetime':25,
    ...
    'district_heating':{ # dh
        'deployment':True,
        # 'deployment':False, # Source: Philippen et al. (2025). CoSi modelling assumptions. SWEET-CoSi
        ...
        'grid_kW_th_max':'inf',
        'investment_dh_grid_per_m': 400, # [CHF / m] !? HOW DO WE CALCULATE THIS VALUE !? 1400 CHF/m urban area DN100 900 CHF/m rural area DN100 These values are for real physical meters built however we dont model that 
    ...
    'solarthermal_rooftop':{ # solar
        'deployment':True, 
        'kW_th_max':'inf',
        'eta_overall':0.7, #REFERENZ SUCHEN
        'lifetime':25,
        'interest_rate':interest_rate,
    ...
    'wind_power':{ # wp
        ...
        'lifetime':25,
        'capex_CHFpkWp': 2190, # 1400, # Source: Bauer, C., S. Hirschberg (eds.), Y. Bäuerle, S. Biollaz, A. Calbry-Muzyka, B. Cox, T. Heck, M. Lehnert, A. Meier, H.-M. Prasser, W. Schenler, K. Treyer, F. Vogel, H.C. Wieckert, X. Zhang, M. Zimmermann, V. Burg, G. Bowman, M. Erni, M. Saar, M.Q. Tran (2017) “Potentials, costs and environmental assessment of electricity generation technologies.” PSI, WSL, ETHZ, EPFL. Paul Scherrer Institut, Villigen PSI, Switzerland. 
    ...
    'hydro_power':{ # hydro # Fokus auf "local" hydro_power !!! MUSS NOCH IN dem_tech.py IMPLEMENTIERT WERDEN!!!
        ...
        'lifetime':25,
        'capex':6735, # [CHF/kW] Source: Bauer, C., S. Hirschberg (eds.), Y. Bäuerle, S. Biollaz, A. Calbry-Muzyka, B. Cox, T. Heck, M. Lehnert, A. Meier, H.-M. Prasser, W. Schenler, K. Treyer, F. Vogel, H.C. Wieckert, X. Zhang, M. Zimmermann, V. Burg, G. Bowman, M. Erni, M. Saar, M.Q. Tran (2017) “Potentials, costs and environmental assessment of electricity generation technologies.” PSI, WSL, ETHZ, EPFL. Paul Scherrer Institut, Villigen PSI, Switzerland. 
    ...
    'tes':{ # tes (thermal energy storage) (large scale, connected to District Heating Network)
        ...
        'tes_gamma':0.0001, # For pit storage loss in 100days from 100%->80%
        ...
        'lifetime':25,
        'capex':3.40, #[CHF/kWh_th] Pit; 19 for Tank Storage; 2.16 for Borehole TES; Richard Lüchinger et al. (2025) Cost Analysis for Large Thermal Energy Storage Systems  DOI: 10.1115/1.4069127 
    ...
    'tes_decentralised':{ # tesdc
        ...
        'lifetime':25,
        'capex':10.5, #1.67, # [CHF/kWh_th] Gabrielli, 2018
    ...
    'deep_geothermal':{ # deep geothermal energy
        'deployment':False,
        'capex': 25000.0, # private communication
