...
energy_mix_CH_dir = path_strt1 + '/data/electricity_mix_CH/' # location of energy mix files
...
wind_power_profiles_dir = path_strt1 + '/data/tech_wind_power/wind_topo_profiles/' # location of wind power hourly profile csv files
...
electricity_mix_file = 'Electricity_Mix_File.feather' # csv-file containing timeseries of hourly electricity mix fractions.
